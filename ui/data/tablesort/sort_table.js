...
SortTable.up = '<img style="margin-bottom:-8px;padding-left:5px;" src="./arrow_top.png">';
SortTable.alt_up = 'Aufwärts sortieren';

// Das Element das angezeigt wird, wenn die Spalte aufwärts sortiert ist
SortTable.down = '<img style="margin-bottom:-8px;padding-left:5px;" src="./arrow_bottom.png">';
...
SortTable.className = 'icontabelle'; 
